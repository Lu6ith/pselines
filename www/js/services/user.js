var app = angular.module('pselines.services.userService', []);
  ...
  var usersRef = new Firebase(FIREBASE_URL + "/users");
	...
	var self = {
		...
		loadUser: function () {
			...
			var currentUserId = $localstorage.get('pselines-user', null);
		 ...
		 */
		logoutUser: function () {
			$localstorage.set('pselines-user', null);
			self.current = {};
		},
		/*
		 Login the user
											...
											.then(function (authData) {
												...
												usersRef.child(authData.uid)
													...
													function (error, committed) {
														...
														//
														$localstorage.set('pselines-user', authData.uid);
